...
**Phase B complete except B7** (blocked on the physical reference device, as is on-device exercise of B2–B8). Parked follow-ups: GPU export/preview EGL context, pre-film-sim peaking tap, vectorscope/false color, HEIF capture, layer blending/masks (M3).
